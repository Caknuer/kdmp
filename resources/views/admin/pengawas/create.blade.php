...
@section('page_title', 'Tambah Pengawas Baru')
@section('page_subtitle', 'Masukkan data dewan pengawas untuk struktur organisasi KDMP')
        ...
        <form action="{{ route('admin.pengawas.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text"
                           ...
                           placeholder="Contoh: Prof. Dr. Ir. Hj. Siti Rahma, M.Sc.">
                    @error('name_p')
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           placeholder="Contoh: Ketua Dewan Pengawas, Anggota Pengawas">
                    @error('role')
                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           placeholder="1">
                    <p class="mt-1 text-xs text-gray-500">Angka lebih kecil tampil lebih awal (contoh: 1 untuk Ketua Dewan Pengawas).</p>
                    @error('order')
                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="bio"
                          ...
                          rows="4"
                          class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                          placeholder="Tuliskan latar belakang profesi, keahlian, atau profil singkat pengawas...">{{ old('bio') }}</textarea>
                @error('bio')
                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
                <label class="flex items-center gap-3 cursor-pointer">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Jika dicentang, pengawas akan langsung ditampilkan di halaman publik KDMP.</p>
                    </div>
                </label>
            </div>
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save"></i> Simpan Pengawas
                </button>
            </div>
        </form>
    </div>
